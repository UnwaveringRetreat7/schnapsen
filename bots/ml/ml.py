...
def features(state):
    ...
    p1_points = state.get_points(id_player_1)

    # Add player 2's points to feature set
    p2_points = state.get_points(id_player_2)

    # Add player 1's pending points to feature set
    p1_pending_points = state.get_pending_points(id_player_1)

    # Add plauer 2's pending points to feature set
    p2_pending_points = state.get_pending_points(id_player_2)
